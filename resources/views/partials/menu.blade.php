<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('ussd_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.ussds.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/ussds") || request()->is("admin/ussds/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('ussd_menu_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.ussd-menus.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/ussd-menus") || request()->is("admin/ussd-menus/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('user_session_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.user-sessions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/user-sessions") || request()->is("admin/user-sessions/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-allergies c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.userSession.title') }}
                </a>
            </li>
        @endcan
