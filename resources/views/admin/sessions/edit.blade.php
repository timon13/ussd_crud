    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sessions.update", [$session->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_code') ? 'is-invalid' : '' }}" type="text" name="service_code" id="service_code" value="{{ old('service_code', $session->service_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('msisdn') ? 'is-invalid' : '' }}" type="text" name="msisdn" id="msisdn" value="{{ old('msisdn', $session->msisdn) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ussd_string') ? 'is-invalid' : '' }}" type="text" name="ussd_string" id="ussd_string" value="{{ old('ussd_string', $session->ussd_string) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('menu') ? 'is-invalid' : '' }}" type="text" name="menu" id="menu" value="{{ old('menu', $session->menu) }}">
                @if($errors->has('menu'))
                    <div class="invalid-feedback">
                        {{ $errors->first('menu') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selection') ? 'is-invalid' : '' }}" type="text" name="selection" id="selection" value="{{ old('selection', $session->selection) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_val') ? 'is-invalid' : '' }}" type="text" name="min_val" id="min_val" value="{{ old('min_val', $session->min_val) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_val') ? 'is-invalid' : '' }}" type="text" name="max_val" id="max_val" value="{{ old('max_val', $session->max_val) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('session_date') ? 'is-invalid' : '' }}" type="text" name="session_date" id="session_date" value="{{ old('session_date', $session->session_date) }}">
