...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'Latest User Sessions (Unique)',
        ...
        $settings2 = [
            'chart_title'           => 'Latest User Session Queries',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Session',
            'group_by_field'        => 'created_at',
        ...
        $settings3 = [
            'chart_title'        => 'Unique User Sessions',
            'chart_type'         => 'pie',
        ...
        $settings4 = [
            'chart_title'        => 'User Session Queries',
            'chart_type'         => 'pie',
            'report_type'        => 'group_by_string',
            'model'              => 'App\Session',
            'group_by_field'     => 'service_code',
